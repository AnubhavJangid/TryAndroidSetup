...
class ProductPagerAdapter(private val homeBannerModal: ArrayList<HomeBannerModal>, private val context: Context) : PagerAdapter()
{
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val layout: View = layoutInflater.inflate(R.layout.layout_pager_product, container, false)
